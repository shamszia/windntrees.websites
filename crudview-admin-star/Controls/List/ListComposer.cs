    ...
    public class ListComposer
    {
        ...
        public static HtmlString composeBasicViews(string formId)
        {
            string basicViews = "<section> " +
                                        ...
                                        "              <button data-bind='click: function() { list(1); }' class='btn btn-default' type='button' title='" + SharedLibrary.Core.Resources.Global.FormMessages.SearchD + "'><span>" + SharedLibrary.Core.Resources.Global.FormMessages.Search + "</span></button> " +
                                        "          </span> " +
                                        "      </div> " +
                                        "  </div> " +
                                        "  <br /> " +
                                        ...
                                        "           <span class='input-group-prepend' data-bind='css: {disabled: CurrentList() == 1}'><a href = '#' data-bind='click: function(){ if (CurrentList() > 1) {list(CurrentList() - 1); } }'><span class='input-group-text'>" + SharedLibrary.Core.Resources.Global.FormMessages.PrevPage + "</span></a></span> " +
                                        "           <span class='input-group-append' data-bind='css: {disabled: CurrentList() == ListNavigator().calculateTotalPages()}'><a href = '#' data-bind='click: function(){ if (CurrentList() < ListNavigator().calculateTotalPages()) {list(CurrentList() + 1); } }'><span class='input-group-text'>" + SharedLibrary.Core.Resources.Global.FormMessages.NextPage + "</span></a></span> " +
                                        "        </div> " +
                                        "</script> " +
                                    "</section> ";
