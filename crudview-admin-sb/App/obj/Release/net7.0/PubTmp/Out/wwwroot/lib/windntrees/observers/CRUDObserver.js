...
/// <summary>
/// CRUDObserver data communication interface provide create, read, update, delete and listing functionality against a http service.
/// </summary>
function CRUDObserver(options) {
    ...
    /// <summary>
    /// Gets forms's (FormObject) stringified object.
    /// </summary>
    ...
    /// <summary>
    /// Gets form's (FormObject) JSON object.
    /// </summary>
