...
namespace DataAccess.Core.Repositories
{
    public class CategoryRepository : EntityRepository<Category>
    {
        ...
        {
            List<GenericListString> contents = ((ApplicationContext)context).Categories.OrderBy(l => l.Name).ToList()
                    .Select(param =>
                    {
        ...
        //All CRUD2CRUD (CRUDL) listing methods require a Total method
        //Default List method also includes a ListTotal method.
