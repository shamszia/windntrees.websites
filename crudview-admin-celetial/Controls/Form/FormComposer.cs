    ...
    public class FormComposer
    {
        ...
        {   
            ...
            if (modal)
            {
                ...
                modalFormCrossButton = "<button type = 'button' class='col-4 order-1 close d-flex justify-content-end' data-dismiss='modal'> <span aria-hidden='true'>&times;</span><span class='sr-only'>" + SharedLibrary.Core.Resources.Global.FormMessages.Close + "</span></button> ";
                formCloseButton = "<button type = 'button' id ='btnCloseAddForm' class='btn btn-primary btn-form-control-primary' data-dismiss='modal'><span>Close</span></button>";
                formOkButton = "<button type = 'button' id='btnOK' class='btn btn-primary btn-form-control-primary' data-dismiss='modal'> <span>" + SharedLibrary.Core.Resources.Global.FormMessages.Done + "</span></button>";
